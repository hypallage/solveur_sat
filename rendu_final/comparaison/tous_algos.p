...
set term pdfcairo
set output "temps_graphe_70.pdf" # le nom du fichier qui est engendre

set title "Temps d'execution moyens pour la nb_sommet/2 colorabilité avec 70% arrete"
...
plot "comparaison_graphe_70.dat" using 1:2 title columnheader(2), \
     "comparaison_graphe_70.dat" using 1:3 title columnheader(3), \
     "comparaison_graphe_70.dat" using 1:4 title columnheader(4)
