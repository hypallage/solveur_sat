(*
Cette execption est levé quand faux apparait dans la table de vérité des clauses.
*)
open Types;;
exception Probleme;;
...
à l'état inverse(desactivé si elle était activé et inversement). On met pour cela le tableau
