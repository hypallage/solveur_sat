...
notre pari precedent c'est à dire s'il ne reste qu'une variable à Inconnu dans une
...
les autres doivent être à faux. Si la clause a une variable à vrai, alors on renvoie l'exception 
clausevrai (car aucune affectation n'est utile). A l'inverse, si toutes les littéraux sont faux 
...
travaillera au contraire sur les clauses dont on met un littéral à faux par notre pari.
*)
...
met a vrai et augmente le nombre de littéraux faux dans la clause.
*)
